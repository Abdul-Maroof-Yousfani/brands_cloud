        ...
        @foreach($Invoice as $row)
            ...
            if ($rema > 0):
                    ...
                    <td class="text-center">
                        @if($rema > 0)
                            <input name="checkbox[]" onclick="check(),supplier_check('',this.id)"
                                ...
                                onchange="CheckUncheck('<?php            echo $counter?>','<?php            echo $row->buyers_id?>')"
                                style="height: 30px;">
                        @else<p>Clear</p>
                        @endif
                    </td>
                ...
                $inv = $data->total ?>
                    ...
                    <?php
                $rema = $data->total - $rece - $return_amount;?>
                ...
                $remaining += $rema + $sale_taxes_amount_rate;
                    ...
                    {{--<td class="text-center"><button onclick="delete_record('{{$row->id}}')" type="button"
