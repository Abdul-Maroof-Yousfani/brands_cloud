                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="panel">
                                                            <div class="panel-body">
                                                                <form method="post"
                                                                    action="<?= url('sad/updateCreditCustomerDetail?m=' . $m . '') ?>"
                                                                    id="submitadv">
                                                                    <div class="row">
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                            <div
                                                                                ...
                                                                                <input type="hidden" name="AccId"
                                                                                    value="<?php echo $Cusomter->acc_id?>">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select name="country" id="country"
                                                                                    ...
                                                                                    @foreach($countries as $key => $y)
                                                                                                                                                                    <option value="{{ $y->id}}" <?php    if ($y->id == $Cusomter->country):
                                                                                            echo "selected";
                                                                                        endif;?>>
                                                                                                                                                                        {{ $y->name}}
                                                                                                                                                                    </option>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select name="state" id="state"
                                                                                    ...
                                                                                    @foreach($States as $key => $y)
                                                                                                                                                                    <option value="{{ $y->id}}" <?php    if ($y->id == $Cusomter->province):
                                                                                            echo "selected";
                                                                                        endif;?>>
                                                                                                                                                                        {{ $y->name}}
                                                                                                                                                                    </option>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select name="city" id="city"
                                                                                    ...
                                                                                    @foreach($Cities as $key => $y)
                                                                                                                                                                    <option value="{{ $y->id}}" <?php    if ($y->id == $Cusomter->city):
                                                                                            echo "selected";
                                                                                        endif;?>>
                                                                                                                                                                        {{ $y->name}}
                                                                                                                                                                    </option>
    ...
    $MCounter = 1;
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <input type="radio"
                                                                                    ...
                                                                                    value="same as company address" {{ strtolower($Cusomter->company_shipping_type) == "same as company address" ? 'checked' : ''}} />
                                                                                <label for="contactChoice1">Same As Company
                                                                                    Address</label>
                                                                                </br>
                                                                                <input type="radio" {{ strtolower($Cusomter->company_shipping_type) == "others" ? 'checked' : ''}} id="others"
                                                                                    name="company_shipping_type"
                                                                                    value="others" />
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <span
                                                                                    class="rflabelsteric"><strong>*</strong></span>
                                                                                <select onChange="taxFiler(this)"
                                                                                    name="tax_filer" class="form-control ">
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <span class="rflabelsteric"></span>
                                                                                <input type="text" name="strn_term"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <label>W.H Tax :</label>
                                                                                <span class="rflabelsteric"></span>
                                                                                <input type="number" name="wh_tax"
                                                                                    id="wh_tax" class="form-control"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <label>Adv Tax :</label>
                                                                                <span class="rflabelsteric"></span>
                                                                                <input type="number" name="adv_tax"
                                                                                    id="adv_tax" class="form-control"
                                                                                ...
                                                                                <select name="store_category"
                                                                                    ...
                                                                                    @foreach($StoresCategory as $category)
                                                                                        <option value="{{$category->id}}"
                                                                                            {{$Cusomter->store_category == $category->id ? 'selected' : ''}}>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select name="territory_id"
                                                                                    id="territory_id" class="form-control">
                                                                                    <option selected value="">Select Option
                                                                                    </option>
                                                                                    @foreach($Territory as $territory)
                                                                                        <option value="{{$territory->id}}"
                                                                                            {{$Cusomter->territory_id == $territory->id ? 'selected' : ''}}>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select name="sale_person" id="sale_person"
                                                                                    ...
                                                                                    @foreach($salesPersons as $person)
                                                                                        <option value="{{ $person->id }}" {{ $Cusomter->SaleRep == $person->id ? 'selected' : '' }}>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select name="customer_group_id"
                                                                                    ...
                                                                                    @foreach($customerGroups as $group)
                                                                                        <option value="{{ $group->id }}" {{ $Cusomter->customer_group_id == $group->id ? 'selected' : '' }}>
                                                                            ...
                                                                            <div
                                                                                class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                <label>Display Pending paymen in Invoice
                                                                                    :</label>
                                                                                <span class="rflabelsteric"></span>
                                                                                <select
                                                                                    name="display_pending_payment_invoice"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select name="branch_id" id="branch_id"
                                                                                    ...
                                                                                    @foreach(\App\Helpers\CommonHelper::get_all_branch() as $branch)
                                                                                        <option value="{{ $branch->id }}" {{ $Cusomter->branch_id == $branch->id ? 'selected' : '' }}>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select onChange="getCustomerType(this)"
                                                                                    ...
                                                                                    <option
                                                                                        data-type="{{strtolower($data->name)}}"
                                                                                        value="{{$data->id}}" {{$Cusomter->
                                                                                        CustomerType == $data->id ?
                                                                                        'selected' :''}}>{{$data->name}}
                                                                                    </option>
                                                                                    @endforeach --}}
                                                                                    <option selected value="">Select Option
                                                                                    </option>
                                                                                    <option data-type="general" value="1"
                                                                                        {{$Cusomter->CustomerType == 1 ? 'selected' : ''}}>General</option>
                                                                                    <option data-type="employee" value="2"
                                                                                        {{$Cusomter->CustomerType == 2 ? 'selected' : ''}}>Employee</option>
                                                                                    <option data-type="reseller" value="3"
                                                                                        {{$Cusomter->CustomerType == 3 ? 'selected' : ''}}>Reseller/
                                                                                        Distributor
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            ...
                                                                            <div id="only_emp"
                                                                                ...
                                                                                <select name="employee_id" id="employee_id"
                                                                                    ...
                                                                                    @foreach(\App\Helpers\SalesHelper::get_all_unregistered_employees() as $employee)
                                                                                        <option value="{{ $employee->id }}" {{ $Cusomter->employee_id == $employee->id ? 'selected' : '' }}>
                                                                                            {{ $employee->name }} --
                                                                                            {{ $employee->id }}
                                                                                        </option>
                                                                                    @endforeach
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select name="region_id" class="select2"
                                                                                    ...
                                                                                    @foreach($regions as $region)
                                                                                        <option value="{{ $region->id }}" {{ $Cusomter->region_id == $region->id ? 'selected' : '' }}>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <span
                                                                                    class="rflabelsteric"><strong>*</strong></span>
                                                                                <select name="warehouse_to"
                                                                                    id="warehouse_to" class="form-control ">
                                                                                    <option value="">Select Option</option>
