...
<style>
    ...
    .gain-text { color: #10b981; font-weight: bold; }
...
<div class="well_N">
    ...
    <div class="filter-card">
        <form id="adjustmentFilterForm" class="row g-3 align-items-center">
    ...
    <div id="reportContainer">
        <div class="report-card text-center py-5">
            <p class="text-muted mb-0">Select filters and click search to view adjustment report.</p>
        </div>
    </div>
</div>
@endsection
...
<script>
    $(document).ready(function() {
        ...
        $('#exportBtn').click(function() {
            let formData = $('#adjustmentFilterForm').serialize();
            window.location.href = "{{ route('list.stock_adjustment_report') }}?" + formData + "&export=excel";
        });
        ...
        function loadReport() {
            ...
            $.ajax({
                url: "{{ route('list.stock_adjustment_report') }}",
                type: 'GET',
                data: formData,
