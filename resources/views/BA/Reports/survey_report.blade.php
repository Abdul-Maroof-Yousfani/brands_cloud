...
<div class="well_N">
    ...
    <div id="reportContainer">
        <div class="report-card text-center py-5">
            <p class="text-muted mb-0">Select filters and click search to view survey responses.</p>
        </div>
    </div>
</div>
@endsection
...
<script>
    $(document).ready(function() {
        ...
        $('#exportBtn').click(function() {
            let formData = $('#surveyFilterForm').serialize();
            window.location.href = "{{ route('list.survey_report') }}?" + formData + "&export=excel";
        });
