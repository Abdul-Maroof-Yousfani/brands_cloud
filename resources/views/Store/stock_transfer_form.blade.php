...
@section('content')
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="row">
                                    <?php echo Form::open(['url' => 'pad/addStockTransfer?m=' . $m . '', 'id' => 'addPurchaseReturnDetail', 'class' => 'stop']); ?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                ...
                                                <input type="text" id="tr_no" name="tr_date"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <select onchange="updateAllWarehouseFrom()" name="main_warehouse_from"
                                                    id="main_warehouse_from" class="form-control requiredField select2">
                                                    <option value="">Select Warehouse</option>
                                                    <?php foreach(CommonHelper::get_all_warehouse() as $Fil):?> <option value="<?php echo $Fil->id; ?>">
                                                        <?php echo $Fil->name; ?></option> <?php endforeach;?>

                                                </select>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <label for="">Location To</label>
                                                <select onchange="updateAllWarehouseTo()" name="main_warehouse_to"
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <select onchange="select_brand(this)" name="brands" id="brands"
                                                    ...
                                                    <table class="table table-bordered sf-table-list">
                                                        <thead>
                                                            <tr class="text-center">
                                                                <th colspan="3" class="text-center">Stock Transfer Detail
                                                                </th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="text-center hide" style="width: 180px;">Batch
                                                                    Code</th>
                                                            ...
                                                            <tr class="text-center AutoNo">
                                                                ...
                                                                <td>
                                                                    <input readonly type="text" name="barcodes[]"
                                                                        ...
                                                                        class="form-control requiredField barCodes"
                                                                        step="any" min>
                                                                </td>
                                                                <td class="hide">
                                                                ...
                                                                <td>
                                                                    <input type="text" name="in_stock_qty[]"
                                                                        id="in_stock_qty1"
                                                                        class="item-stock form-control requiredField"
                                                                ...
                                                                <td style="display: none">
                                                                    <input readonly type="number" name="rate[]"
                                                                ...
                                                                <td><button type="button" class="btn btn-xs btn-primary"
                                                                        id="BtnAddMore" onclick="AddMoreRows()">Add
                                                                        More</button></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
        ...
        $(document).on('change', '.items', function() {
            ...
            if (parseInt(oldVal.split("~")[0]) > 0) {
                $(".items").not(this).each(function() {
                    $(this).find(`option[value="0"]`).after(
                        `<option value="${oldVal.split("~")[0]}">${oldVal.split("~")[1]}</option>`);
                })
            }
        });
        ...
        function AddMoreRows() {
            ...
            allItems.forEach(function(item) {
                if (!selectedItems.includes(item.id.toString())) {
                    optionsHtml += '<option value="' + item.id + '">' + item.sku_code + ' - ' + item.product_name +
                        '</option>';
                }
            });
            ...
            $('#AppendHtml').append(
                ...
                '<td>' +
                '<select onchange="selectElement(this)" name="item_id[]" class="form-control select2 items" id="sub_' +
                Counter + '">' +
                optionsHtml +
                '</select>' +
                '</td>' +
                ...
                "</td>" +
                '<td class="hide">' +
                '<select onchange="get_stock_qty(this.id,' + Counter +
                ')" class="form-control requiredField select2" name="batch_code[]" id="batch_code' + Counter + '">' +
                '<option value="">Select Batch</option>' +
                '</select>' +
                '</td>' +
                '<td><input type="text" style="width: 100%;" name="in_stock_qty[]" id="in_stock_qty' + Counter +
                '" class="form-control requiredField" readonly></td>' +
                '<td><input onkeyup="check_qty(this.id,' + Counter + ')" type="text" name="qty[]" id="qty' + Counter +
                '" class="form-control requiredField SendQty"></td>' +
                '<td style="display: none"><input readonly type="number" name="rate[]" id="rate' + Counter +
                '" class="form-control"></td>' +
                '<td style="display: none"><input readonly type="number" name="amount[]" id="amount' + Counter +
                '" class="form-control"></td>' +
                '<td><button type="button" class="btn btn-xs btn-danger" id="BtnRemove' + Counter +
                '" onclick="RemoveRows(' + Counter + ')">X</button></td>' +
                '</tr>'
            );
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(i, warehouse) {
                        $from.append('<option value="' + warehouse.id + '">' + warehouse.name +
                            '</option>');
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(i, warehouse) {
                        ...
                        $to.append('<option value="' + warehouse.id + '">' + warehouse.name +
                            '</option>');
                    });
                    ...
                    if (data && data !== '') {
                        ...
                        for (var i = 0; i < parts.length; i++) {
                            if (parts[i] !== '' && !isNaN(parts[i])) {
                                batchDropdown.append('<option value="BATCH-' + (i + 1) + '">BATCH-' + (i + 1) +
                                    '</option>');
                            }
                        }
    ...
    <script>
        ...
        function AddMoreRows() {
            ...
            //         optionsHtml +=
            //             `<option value="${item.id}" data-brand="${item.brand_id}">${item.sku_code} - ${item.product_name}</option>`;
            //     }
            // }
