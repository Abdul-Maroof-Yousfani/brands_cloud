                                                    ...
                                                    <table class="table table-bordered sf-table-list">
                                                        ...
                                                        <tbody id="AppendHtml">
                                                            <tr class="text-center AutoNo">
                                                                <td>
                                                                    <select onchange="selectElement(this)" name="item_id[]" class="form-control select2 items" id="sub_1" >
                                                                        <option value="0">Select item</option>

                                                                        @foreach (CommonHelper::get_all_subitem_get() as $item)
                                                                            <option value="{{$item->id}}" data-brand="{{ $item->brand_id }}" data-item="item-{{ $item->id }}">{{$item->sku_code.' - '. $item->product_name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <input readonly type="text" name="barcodes[]" id="barcodes" style="width: 100%; text-align: center;" class="form-control requiredField barCodes" step="any" min>
                                                                </td>
                                                                <td class="hide">
                                                                ...
                                                                <td>
                                                                    <input type="text" name="in_stock_qty[]" id="in_stock_qty1" class="item-stock form-control requiredField" readonly style="width: 100%;">
                                                                </td>
                                                                <td>
