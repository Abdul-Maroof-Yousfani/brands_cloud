    ...
    <div class="row well_N align-items-center">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <ul class="cus-ul">
                ...
                <li>
                    <h3><span class="glyphicon glyphicon-chevron-right"></span> &nbsp;Edit Sale Order</h3>
                </li>
            </ul>
        </div>
                                ...
                                <div class=" qout-h">
                                    ...
                                    <div class="row" style="padding-block:30px;">
                                        <div class="col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                            <h2 class="subHeadingLabelClass">Sale Order Details</h2>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label class="control-label" style="margin-bottom: 0;">SO No. </label>
                                                     <input readonly name="sale_order_no" class="form-control"
                                                               value="{{ $sale_orders->so_no }}" type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label class="control-label" style="margin-bottom: 0;">SO Date</label>
                                                         <input name="sale_order_date" value="{{ date('Y-m-d', strtotime($sale_orders->so_date)) }}"
                                                ...
                                                <div class="col-md-6 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    <select onchange="getCustomer(this)" name="customer_name"
                                                            class="form-control" id="customer_name">
                                                        <option value="">Select</option>
                                                        @foreach(CommonHelper::get_customer() as $item)
                                                            <option value="{{$item->id}}"
                                                                    {{ $sale_orders->buyers_id == $item->id ? 'selected' : '' }}
                                                                    id="customer_name">
                                                                {{$item->name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="phone_no" id="phone_no" class="form-control"  value="{{ $sale_orders->phone_no }}"
                                                               type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="address" id="address"  value="{{ $sale_orders->address }}" class="form-control" type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <label class="control-label" style="margin-bottom: 0;">Branch</label>
                                                          <input name="branch" id="branch" class="form-control" type="text" value="{{$sale_orders->branch}}">
                                                    </div>
                                                </div>
                                                ...
                                                @endphp
                                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    <select style="width: 100%;" id="warehouse_from"
                                                            onChange="checkCustomerSelected(this);get_product_by_brand(this,1);getBrandCustomerDiscount(this,1);"
                                                            name="warehouse" class="form-control select2 warehouse_from form-group">
                                                        <option value="">Select Warehouse</option>
                                                        @foreach(CommonHelper::get_all_warehouse() as $item)
                                                            <option {{ $item->id == ($sale_orders->warehouse_from ? $sale_orders->warehouse_from : $buyer_detail->warehouse_from) ? 'selected' : '' }} value="{{$item->id}}">{{$item->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                   <input name="balance_amount" class="form-control form-control2"
                                                           style="background: white !important;" value="0.00" type="text"
                                                ...
                                                <div class="col-lg-5">
                                                  <input name="credit_limit" class="form-control form-control2"
                                                           style="background: white !important;" value="0.00" type="text"
                                                           id="amount_limit" readonly>
                                                </div>
                                                <div class="col-lg-7">
                                                    <h5>Current Balance Due</h5>
                                                </div>
                                                <div class="col-lg-5">
                                                     <input name="current_balance_due" class="form-control form-control2"
                                                           style="background: white !important;" value="0.00" type="text"
                                                           id="current_balance_due" readonly>
                                                </div>
                                                <div class="col-lg-7">
                                                    <h5>N.T.N No</h5>
                                                </div>
                                                <div class="col-lg-5">
                                                    <input name="n-t-n" class="form-control form-control2"
                                                           style="background: white !important;" value="" type="text"
                                                           id="NTN_No" readonly>
                                                </div>
                                                <div class="col-lg-7">
                                                    <h5>S.T No</h5>
                                                ...
                                                <div class="col-lg-5">
                                                   <input name="s-t-no" class="form-control form-control2"
                                                           style="background: white !important;" value="" type="text"
                                                           id="ST_No" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <table class="userlittab table table-bordered sf-table-list" id="more_details">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="main">
                                                    ...
                                                    <td>
                                                        <select style="width: 150px;" onChange="checkCustomerSelected(this);get_product_by_brand(this,1);getBrandCustomerDiscount(this,1);" name="brand_id[]" class="form-control select2 brands" id="brand_id1" >
                                                            <option value="">Select</option>
                                                    ...
                                                    <td>
                                                       <input style="width: 70px;" readonly name="c_stock[]" class="form-control c_stock"  value="{{ CommonHelper::getCustomerAssignedWarehouse($sale_orders->buyers_id, $item->item_id) }}"  type="text" id="c_stock" tabindex="-1">
                                                    </td>
                                                    <td>
                                                       <input style="width: 70px;" readonly name="r_stock[]" class="form-control r_stock" value="{{ App\Helpers\ReuseableCode::get_reserved_so($item->item_id, $sale_orders->buyers_id) }}" type="text" id="r_stock" tabindex="-1">
                                                    </td>
                                                    ...
                                                    <td>
                                                         <input style="width: 70px;"  onkeyup="calculation_amount(); checkQtyStock(this); totalQty();" name="qty[]" class="form-control qty next-total" value="{{ $item->qty }}" type="text" id="qty" tabindex="0">
                                                   

                                                        
                                                    <td>
                                                        <input style="width: 65px;" onkeyup="calculation_amount()" name="foc[]" class="form-control" {{ $item->foc }} type="text" id="foc" tabindex="-1">
                                                    </td>
                                                      <td>
                                                        <input style="width: 80px;" name="rate[]" onkeyup="calculation_amount()" class="form-control"  value="{{ $item->rate }}" type="text" id="sale_price" tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 80px;" readonly name="mrp_price[]" class="form-control"  value="{{ $item->mrp_price }}" type="text" id="mrp_price" tabindex="-1">
                                                    </td>
                                                    <td class="hide">
                                                        <input style="width: 110px;" readonly name="is_tax_apply[]" class="form-control" value="{{ optional(CommonHelper::get_product_by_id($item->item_id))->is_tax_apply ?? '' }}" type="text" id="is_tax_apply" tabindex="-1">
                                                    </td>
                                                    
                                                    <td class="hide">
                                                        <input style="width: 100px;" readonly name="tax_type_id[]" class="form-control" value="{{ optional(CommonHelper::get_product_by_id($item->item_id))->tax_type_id ?? '' }}" type="text" id="tax_type_id" tabindex="-1">
                                                    </td>
                                                    <td class="hide">
                                                        <input style="width: 100px;" readonly name="tax_applied_on[]" class="form-control" value="{{ optional(CommonHelper::get_product_by_id($item->item_id))->tax_applied_on ?? '' }}" type="text" id="tax_applied_on" tabindex="-1">
                                                    </td>
                                                    <td class="hide">
                                                        <input style="width: 62px;" readonly name="tax_policy[]" class="form-control" value="{{ optional(CommonHelper::get_product_by_id($item->item_id))->tax_policy ?? '' }}" type="text" id="tax_policy" tabindex="-1">
                                                    </td>
                                                  
                                                    <td>
                                                        <input style="width: 110px;" name="gross_amount[]" class="form-control gross_amount" value="{{ $item->sub_total }}" type="text" id="gross_amount" tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 100px;" readonly onkeyup="calculation_amount(); get_discount();" name="discount1[]" class="form-control dicountget" value="{{ $item->discount_percent_1 }}"type="text" id="discount1" tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 100px;" readonly name="discount_amount1[]" class="form-control discount_amount" value="{{ $item->discount_amount_1 }}" type="text" id="discount_amount1" tabindex="-1">
                                                    </td>
                                                    <td class="hide">
                                                        <input readonly style="width: 100px;" onkeyup="calculation_amount(); get_discount();" name="discount2[]" class="form-control" value="{{ $item->discount_percent_2 }}" type="text" id="discount2" tabindex="-1">
                                                    </td>
                                                    <td class="hide">
                                                        <input readonly style="width: 100px;" name="discount_amount2[]" class="form-control" value="{{ $item->discount_amount_2 }}" type="text" id="discount_amount2" tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 62px;" onkeyup="calculation_amount()" name="tax[]" class="form-control sale_tax_rate " value="{{ $item->tax }}" type="number" id="sale_tax_rate" tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 90px;" readonly name="total_tax[]" class="form-control total_tax" value="{{ $item->tax_amount }}" type="text" id="total_tax"  tabindex="-1">
                                                    </td>
                                                    <td>
                                                        <input style="width: 111px;" readonly name="total_amount[]" class="form-control total" value="{{ $item->amount }}" type="text" id="total"  tabindex="-1">
                                                    </td>
                                                    <td>
                                                ...
                                                <li class="text-left">
                                                    <input name="total_qty"  style="background: white !important;"
                                                           class="form-control form-control2" id="total_qty"
                                                            value="{{ $sale_orders->total_qty }}"  type="text"  readonly>
                                                </li>
                                                <li>Total Item</li>
                                                <li class="text-left">
                                        ...
                                        <div class="padt">
                                            ...
                                            <ul class="sale-l sale-l2">
                                                ...
                                                <li class="text-left"><input name="total_sales_tax"
                                                                             ...
                                                                             class="form-control form-control2"  value="{{ $sale_orders->sales_tax_rate }}"
                                                                             type="text"  readonly></li>
                                            </ul>
...
function AddMoreDetails() {
    var Counter = $('.main').length + 1;
    var previousBrandId = $('#brand_id' + (Counter - 1)).val();
    //  var previousWarehouseId = $('#warehouse_from' + (Counter - 1)).val(); 
    ...
    $('#more_details').append(`
        <tbody id="RemoveRows${Counter}">
            <tr class="main">
                ...
                <td>
                    <input style="width: 70px;" readonly name="r_stock[]" class="form-control r_stock" value="0" type="text" id="r_stock" tabindex="-1">
                </td>
                <td class="hideon33 hide" style="display:${hideshow}">
                    <select name="to_warehouse[]" class="form-control to_warehouse" id="to_warehouse" style="width:70px;" tabindex="-1"></select>
                </td>
    ...
    //     $('#warehouse_from' + Counter).val(previousWarehouseId).trigger('change');
    // }
    ...
    //     Swal.fire({
    //         title: 'Processing...',
    //         text: 'Please wait while the sale order is being updated.',
    ...
    //                     icon: 'success',
    //                     title: 'Success',
    //                     text: response.message || 'Sale order updated successfully!',
    ...
    //                     icon: 'error',
    //                     title: 'Error',
    //                     text: response.message || 'Failed to update sale order.',
    //                     confirmButtonText: 'OK'
    //                 });
    //             }
    //         },
    //         error: function(xhr) {
    //             Swal.close();
    //             var errorMessage = 'An error occurred while updating the sale order.';
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                Swal.fire({
                    ...
                    localStorage.setItem("showSaleOrderId", saleOrderId);
                    localStorage.setItem("showSaleOrderRoute", route);

                    // Redirect to listSaleOrder page
                    window.location.href = '{{ route("listSaleOrder") }}';
                });
...
$('.main').each(function () {
   ...
   let products = [];
let productHash = {}; // brand -> array of products

function load_all_products() {
    $.ajax({
        url: '{{ route("getAllSubItem") }}',
        type: 'GET',
        success: function(data) {
            products = data;
            ...
            products.forEach(product => {
                // assume product is a string containing data-brand="BRAND"
                const match = product.match(/data-brand="([^"]+)"/);
                if (match) {
                    const brand = match[1];
                    if (!productHash[brand]) productHash[brand] = [];
                    productHash[brand].push(product);
                }
            });
...
function get_product_by_brand(element, number) {
    ...
    // O(1) lookup in hash
    const filteredProducts = productHash[value] || [];
    
    // append to DOM
    $("#product_id" + number).html(filteredProducts.join(""));
}
    ...
    function getCustomerAssignedWarehouse(element) {
        ...
        var warehouse = $("#warehouse_from").val();


        console.log(customer);
        $.ajax({
            url: '{{ url("/getCustomerAssignedWarehouseByWarehouse") }}',
            type: 'GET',
            data: {
