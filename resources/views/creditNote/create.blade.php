                        ...
                        <div class="row qout-h">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="delivery_man" id="delivery_man" value="{{ old('delivery_man') }}" placeholder="-">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="date_and_time" name="date_and_time" value="{{ old("date_and_time") }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="debit" id="debit">
                                        ...
                                        @foreach($accounts as $y)
                                            <option {{ old('debit') == $y->id ? 'selected' : '' }} value="{{ $y->id }}">
                                                {{ $y->code .' ---- '. $y->name }}
                                            </option>
                                        @endforeach
                                    </select>
