@foreach($sales_report_data as $data)
    <tr>
        ...
        <td class="text-center">{{ App\Helpers\CommonHelper::get_additional_sales_tax($data->so_no) ? App\Helpers\CommonHelper::get_additional_sales_tax($data->so_no)->sale_taxes_amount_rate : 0 }}</td>
